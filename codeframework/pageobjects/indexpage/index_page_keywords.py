...
class IndexPageKeywords(BasePage):
    ...
    def verify_index_page_elements(self):
        # 验证前台界面文档访问的文本
        self.element_text_should_be(index_page_location.index_div_document_access, index_page_text.index_document_access_text)

        # 验证前台界面个人文件的文本
        self.element_text_should_be(index_page_location.index_span_person_file, index_page_text.index_personal_file_text)
        ...
        # 验证前台界面共享管理的文本
        self.element_text_should_be(index_page_location.index_div_share_management, index_page_text.index_share_management_text)
